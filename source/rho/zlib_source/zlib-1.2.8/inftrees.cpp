 ...
 */
sInt ZLIB_INTERNAL inflate_table(
codetype type,
uShort FAR *lens,
uInt codes,
code FAR * FAR *table,
...
uShort FAR *work)
{
    ...
    sInt left;                   /* number of prefix codes available */
    ...
    sInt end;                    /* use base and extra for symbol > end */
    ...
    if (max == 0) {                     /* no symbols to code at all */
        here.op = (Byte)64;    /* invalid code marker */
        here.bits = (Byte)1;
        here.val = (uShort)0;
    ...
    for (;;) {
        ...
        if ((sInt)(work[sym]) < end) {
            here.op = (Byte)0;
            here.val = work[sym];
        }
        else if ((sInt)(work[sym]) > end) {
            here.op = (Byte)(extra[work[sym]]);
            here.val = base[work[sym]];
        }
        else {
            here.op = (Byte)(32 + 64);         /* end of block */
            here.val = 0;
        }
